...
function koeingseggaageraproduct() {
    return (
        <>
            <div className="container">
                <div className="selection1 row">
                    <div className="col-sm-4">
                        <div className="slide">
                            <img className="img-responsive" src="maseratis/ghibli.png" />
                        </div> 
                    ...
                    <div className="col-sm-4">
                        <div className="slide">
                            <img className="img-responsive" src="maseratis/granturismo.png" />
                        </div> 
                        <div className="col-sm-6">
                            <h3>Weekly</h3>
                            <button><a href=""></a>Rent Now</button>
...
export default koeingseggaageraproduct